    ...
    public List<Integer> getInorder(TreeNode root) {
        ...
        while (cur != null) {
            ...
            if (cur.left == null) {
                ...
                // toh daldo inorder list mei and move to the right child
                inorder.add(cur.val);
                cur = cur.right;
            } else {
                ...
                // in the left subtree)
                // curr ko vhe save krlia 
                // taki es prev ke right child ko curr se link kr sako
                ...
                // and move to the left child to continue traversal
                if (prev.right == null) {
                    prev.right = cur;
                    cur = cur.left;
                } else {
